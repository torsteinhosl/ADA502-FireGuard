...
Du kan søke etter steder, eller:
  Finn ditt område(trykk på kartet) og trykk "Submit place" og "Add to favorite". Værdata for ditt område vil nå bli lagret i databasen og brukes     til fireguardmodellen.
